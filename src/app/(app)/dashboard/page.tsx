...
// (see NetWorthCard.tsx). Net Worth History comes next, full-width, above
// Expense Categories -- per your call swapping the two charts' positions
// from their prior arrangement.
